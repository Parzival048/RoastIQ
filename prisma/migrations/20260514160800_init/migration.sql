...
CREATE TABLE "Scan" (
    ...
    "roastComments" JSONB NOT NULL,
    "professionalFeedback" JSONB NOT NULL,
    "redesignSuggestions" JSONB NOT NULL,
    "heroRewrite" TEXT,
...
-- CreateIndex
CREATE INDEX "Scan_slug_idx" ON "Scan"("slug");

-- CreateIndex
CREATE INDEX "Scan_isPublic_idx" ON "Scan"("isPublic");
